...
const delayNormal = 500;
const delayAccelerated = 500;
  ...
  interval = setInterval(() => {
    if (points[currentPoint][0] < field.getBoundingClientRect().top * -1) {
      ...
      for (currentPoint; currentPoint < newPoint; currentPoint++)
        field.innerHTML += `<li class='block block-${currentPoint}' style='top: ${points[currentPoint][0] + shift}px; left: ${points[currentPoint][1]}px'></li>`;
    }
