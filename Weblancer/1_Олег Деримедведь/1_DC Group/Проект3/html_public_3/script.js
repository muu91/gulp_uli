$(document).ready(function(e) {
  ...
  // END DROP DOWN
  // DROP DOWN MEDIA
  $('.drop_arrow__media').click(function() {
...
//   $("ul > li:nth-child(2) .a__tab_nav").addClass("active__tab_nav");
//   $("[data-tab_content=info]").show();
//   
//   
  $("ul > li:nth-child(1) > a").addClass("active__tab_nav");
  $("[data-tab_content=guest]").show();
  ...
  tabNavBtn.on("click", function(e) {
   ...
   if (identifier == "#contact__tab") {
    $('.become__nav a').removeClass('active__tab_nav');
    $('.become__nav > ul:nth-child(1) > li:nth-child(2) > a').addClass('active__tab_nav');
    $('.tab__form').hide();
    $('.tab__contacts').show();
 }	
...
// $("href=http://185.195.26.141/belgravia/become_a_quest").click(function(e) {

//    $("[data-filter_tab=guest]").click();
//   });
	
// 	else if (identifier != "#contact__tab")  {
...
//   }
 ...
 //   $(this).each(function() {
   //   $('.videos__subitem > video').get(0).pause();
   // });
 //   $(this).find(".videos__subitem > video").get(0).play();
 });
//   
//   
//   итс май аякс код
//   $(".videos__item").on("click", function() {
//     $(this).find("img, a").hide();
//     $(this).find("video").get(0).play();
//   });
//  конец итс май аякс код	
...
//AUDIO BUTTON INDEX
    ...
    var soundFile = ["https://mcdn.podbean.com/mf/web/giwghw/39_full_audio_final_edit9eqb2.mp3"];
...
$(document).ready(function(e) {
  ...
  $('.bl_last_episode__text > a').click(function(e) {
    e.preventDefault();
   })
});

//END AUDIO BUTTON INDEX
