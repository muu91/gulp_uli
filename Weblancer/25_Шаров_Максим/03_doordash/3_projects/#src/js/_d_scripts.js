$(document).ready(function () {
  ...
  // ----------------------------------------
  // ---------- EDIT PROFILE ----------
  $(".btn-open-add-address-js").click(function (e) {
    e.preventDefault();
    $(".add-address-form-js").slideDown();
  });
  $(".btn-close-add-address-js").click(function (e) {
    e.preventDefault();
    $(".add-address-form-js").slideUp();
    $('.add-address-form-js').find('input').val('');
  });
  // ---------- END EDIT PROFILE ----------
  // ----------------------------------------
