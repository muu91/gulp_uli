...
let path = {
    ...
    src: {
        ...
        img: [
            source_folder + "/img/**/*.{jpg,svg,png,gif,ico,webp}",
            "!" + source_folder + "/img/svg/*.svg"
        ],
...
function watchFiles() {
    ...
    gulp.watch([path.watch.svg], svgg);
...
let build = gulp.series(clean, gulp.parallel(html, js, css, pug_fun, images, svgg, fonts, video, libs));
